...
var _ = Describe("MinerSet Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind MinerSet")
			err := k8sClient.Get(ctx, typeNamespacedName, minerset)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance MinerSet")
